...
class CNN(torch.nn.Module):
    def __init__(self, num_bins): 
        ...
        # conv2d
        self.conv1 = torch.nn.Conv2d(3, 16, stride=3, kernel_size=(9,9))
        self.pool1 = torch.nn.MaxPool2d((3,3),stride=3)
        self.bn1 = torch.nn.BatchNorm2d(16)
        
        # conv2d
        self.conv2 = torch.nn.Conv2d(16,32, stride=1, kernel_size=(3,3))
        self.pool2 = torch.nn.MaxPool2d((2,2),stride=2)
        self.bn2 = torch.nn.BatchNorm2d(32)
        
        # conv2d / dense
        self.conv3 = torch.nn.Conv2d(32,num_bins, kernel_size=(2,11))
